...
movies_file_id = "1tUhkx7VcCdX0FCpfvPkEhsZrzkqsftUC"
similarity_file_id = "1oqVjmRUYrSfnTZyC0L5R8QN5r080BOCo"

# -------- DOWNLOAD PKL FILES --------

if not os.path.exists("movies.pkl"):
    gdown.download(id=movies_file_id, output="movies.pkl", quiet=False)

if not os.path.exists("similarity.pkl"):
    gdown.download(id=similarity_file_id, output="similarity.pkl", quiet=False)
